    ...
    return (
        ...
        <div className="grid md:grid-cols-2 md:gap-6">
            ...
            <input
                ...
                name="birth_date"
                id="birth_date"
                className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 focus:outline-none focus:ring-0 focus:border-blue-600 peer pr-10"
                placeholder=" "
                required
            />
            <label
        ...
        <button
            type="submit"
            className="w-full rounded bg-indigo-600 py-2 px-4 text-white hover:bg-indigo-700 cursor-pointer"
        >
            Create account
        </button>
        </form>
