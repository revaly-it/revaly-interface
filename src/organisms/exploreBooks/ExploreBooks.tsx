...
export default function ExploreBooksClient() {
    ...
    return (
        <>
            <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-6">
                <h1 className="text-3xl font-bold mb-4 md:mb-0">Explore Books: {selectedGenre}</h1>
            </div>
            ...
            <div className="flex flex-col md:flex-row gap-6">
                ...
                {isLoading
                    ? Array.from({ length: maxResults }).map((_, i) => <BookCardSkeleton key={i} />)
